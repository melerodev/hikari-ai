  ...
  return (
    <>
              ...
              <AnimatePresence>
                {showMenu && (
                  <motion.div
                    ...
                    className="absolute right-0 top-full mt-1 w-32 rounded-lg border border-zinc-200 bg-white py-1 shadow-lg dark:border-zinc-800 dark:bg-zinc-900 z-[200]"
                  >
                    <button
      ...
      <RenameModal
        ...
        description={`${t("renameFolderDesc")} "${name}"`}
      ...
      <ConfirmDialog
        ...
        description={`${t("deleteFolderDesc")} "${name}"?`}
        ...
        warningMessage={t("deleteFolderWarning")}
      />
    </>
  )
}
