...
export async function POST(request: NextRequest) {
  try {
    ...
    const modelId = requestedModel || "gpt-5"
    const MODEL = GPT_MODELS[modelId] || "openai/gpt-5"
        ...
        return NextResponse.json(
          {
            ...
            message:
              "Se ha excedido el límite de solicitudes a la API de GPT. Por favor, espera unos minutos antes de intentar nuevamente.",
          },
          { status: 429 },
        )
      }
