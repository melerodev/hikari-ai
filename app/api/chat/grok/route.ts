...
export async function POST(request: NextRequest) {
  try {
    ...
    const modelId = requestedModel || "grok-3"
    const MODEL = GROK_MODELS[modelId] || "xai/grok-3"
        ...
        return NextResponse.json(
          {
            ...
            message:
              "Se ha excedido el límite de solicitudes a la API de Grok. Por favor, espera unos minutos antes de intentar nuevamente.",
          },
          { status: 429 },
        )
      }
